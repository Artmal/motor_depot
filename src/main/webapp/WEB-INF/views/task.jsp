...
<fmt:setBundle basename="i18n.task" />
...
<head>
    ...
    <title><fmt:message key="task.header"/></title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
            <h1><fmt:message key="task.header"/></h1>

            <table id="result-table" class="table table-striped table-bordered" width="100%" cellspacing="0">
                <thead>
                <tr>
                    <th><fmt:message key="task.table.carId"/></th>
                    <th><fmt:message key="task.table.amountOfTrips"/></th>
                </tr>
                </thead>
                <tbody>
