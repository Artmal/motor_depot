            ...
            <c:choose>
                    ...
                    <c:forEach items="${setOfTripRequests}" var="tripRequest">
                        ...
                        <div class="card">
                                    ...
                                    <c:when test="${tripRequest.tripInfo.tripStatus.displayName() eq 'Open'
                                        ...
                                        <a href="/driver-dashboard/my-requests/discard?trip-request-id=${tripRequest.id}"
                                           ...
                                           class="btn btn-danger btn-sm btn-space">
                                            <fmt:message key="driverDashboard.myRequestPage.discard"/>
                                        </a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="/driver-dashboard/my-requests/discard?trip-request-id=${tripRequest.id}"
                                           style="float: right"
                                           class="btn btn-danger btn-sm btn-space disabled">
                                            <fmt:message key="driverDashboard.myRequestPage.discard"/>
                                        </a>
                                    </c:otherwise>
                                </c:choose>
                            ...
                            <div class="card-block">
                                ...
                                <strong><fmt:message key="driverDashboard.myRequestsPage.label.trip"/></strong>
                                <a href="/driver-dashboard/trip?trip-id=${tripRequest.tripInfo.id}">
                                    <fmt:message key="driverDashboard.myRequestsPage.label.trip"/>
                                ...
                                <strong><fmt:message key="driverDashboard.myRequestsPage.label.carModel"/>: </strong>
                                    ${tripRequest.carInfo.model}<br>

                                <i class="fa fa-users fa-fw"></i>
                                <strong><fmt:message key="driverDashboard.myRequestsPage.label.numberOfSeats"/>: </strong>
                                    ${tripRequest.carInfo.numberOfSeats}<br>

                                <i class="fa fa-tint fa-fw"></i>
                                <strong><fmt:message key="driverDashboard.myRequestsPage.label.color"/>: </strong>
                                    ${tripRequest.carInfo.color}<br>

                                <i class="fa fa-clock-o fa-fw"></i>
                                <strong><fmt:message key="driverDashboard.myRequestsPage.label.dateOfCreation"/>:</strong>
                ...
                <c:otherwise>
                    <div class="alert alert-info" role="alert">
                        <fmt:message key="driverDashboard.myRequestsPage.noRequestsYet"/>
                    </div>
                </c:otherwise>
            </c:choose>
        </main>
