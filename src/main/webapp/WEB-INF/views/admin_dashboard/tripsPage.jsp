            ...
            <div class="card">
                <div class="card-block">
                    <form class="form-horizontal" action="/admin-dashboard/dispatcherServlet" method="post">
                        ...
                        <label for="type">Car Type Required*:</label>
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <div class="input-group-addon">
                        ...
                        <label for="name">Town from*:</label>
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <div class="input-group-addon">
                        ...
                        <label for="passport-serial-numbers">Town to*:</label>
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <div class="input-group-addon">
                        ...
                        <label for="phone-number">Time out*:</label>
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <div class="input-group-addon">
